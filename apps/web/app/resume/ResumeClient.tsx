...
/**
 * Interactive resume UI. `isReadOnly` switches off every mutation
 * affordance (upload, AI question generation) so this same component can
 * back the grandfathered view for free users with legacy resume data.
 */
export default function ResumeClient({ isReadOnly = false }: { isReadOnly?: boolean }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      {isReadOnly && (
        <div className="mb-6">
          <FeatureReadOnlyBanner feature="resume" />
        </div>
      )}
